...
class TestCacheInvalidation:
    ...
    @patch('common.utils.firestore_helpers.doc_to_json')
    @patch('services.hackathons_service.get_single_hackathon_event')
    @patch('services.hackathons_service.get_single_hackathon_id')
    @patch('services.hackathons_service.get_hackathon_list')
